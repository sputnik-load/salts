...
class TestUselessTR(unittest.TestCase):
    ...
    def _insert_dead_references(self, ref_values):
        ...
        ref_values["version"] = "2.0.70.6afisha"
        ref_values["rps"] = "r:line(1, 10, 1m) const(10, 60m)"
        ref_values["graph_url"] = "http://grafana-test.ix.km/#/dashboard/db/tankresultstpl?var-system=fe_afisha&var-collector=f2-afisha-101.ix.km&from=20151016T131705&to=20151016T141812"
        ref_values["generator"] = "tank-1"
        ref_values["user"] = "suhov"
        ...
        query = """ insert into salts_testresult 
                    (test_id, dt_start, dt_finish, \"group\",
                    ...
                    returning id
                    """ % ( ref_values["test_id"], ref_values["group"], ref_values["test_name"],
