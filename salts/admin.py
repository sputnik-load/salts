...
class TestResultAdmin(admin.ModelAdmin):
    ...
    list_display = ('test_name', 'group', 'version', 'test_status', 'rps', 'show_test_len', 'q99', 'q90', 'q50', 'http_errors_perc', 'net_errors_perc', 'generator', 'show_graph_url', 'user', 'ticket_id', 'test_id', )
